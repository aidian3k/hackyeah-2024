                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-5">
                        {learningResources && learningResources.map((resource, i) =>
                            <AlternativeMaterialTile key={i}
                                                        id={resource.id}
                                                     author={{
                                                         name: resource.author?.nickName ?? "Cezary Skorupski",
                                                     ...
                                                     rating={resource.reviewDTO?.rating ?? "Brak ocen"}
                        ...
                        {!learningResources || learningResources.length === 0 && <>
                            <AlternativeMaterialTile id={1} {...alternativeMaterialMock} />
                            <AlternativeMaterialTile id={2} {...alternativeMaterialMock} />
                            <AlternativeMaterialTile id={3} {...alternativeMaterialMock} />
                            <AlternativeMaterialTile id={4} {...alternativeMaterialMock} /></>}
                    </div>
                </div>
            </main>
            <Footer/>
